...
# Based on the YELLOW capture, which is the most complex and reliable template.
...
# Packet 2: Color Data Template from the YELLOW capture.
TEMPLATE_SET_COLOR_PROPERTIES = bytes.fromhex(
    "043404062100000000060404ff00ffff000300000000000000000000"
    "ffff00" # Placeholder for second color location
...
def create_true_static_color_sequence(r, g, b):
    ...
    This version writes the color data to BOTH required locations in the data packet.
    """
    ...
    # Inject the RGB color at BOTH locations.
    
    # Location 1: Bytes 14, 15, 16
    packet_list[14] = r
    packet_list[15] = g
    packet_list[16] = b
    
    # Location 2: Bytes 28, 29, 30
    packet_list[28] = r
    packet_list[29] = g
    packet_list[30] = b
...
def main():
    ...
    try:
        ...
        print("Enter RGB color values (e.g., '255 255 0' for yellow).")
