...
def create_true_static_color_sequence(r, g, b):
    ...
    The color format is standard RGB at bytes 28, 29, and 30.
    """
    ...
    # *** THE FINAL FIX ***
    # Inject the RGB color at the correct offsets: 28, 29, 30
    packet_list[28] = r
    packet_list[29] = g
    packet_list[30] = b
...
def main():
    ...
    try:
        ...
        print("\n--- Gembird KB-G460 TRUE Color Control (Final Corrected Version) ---")
