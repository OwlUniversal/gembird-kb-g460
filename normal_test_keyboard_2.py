...
# Packet 2: Color Data Template. This is a known-good packet for RED.
# We will overwrite the color bytes at indices 18, 19, and 20.
...
def create_true_static_color_sequence(r, g, b):
    ...
    The color format is standard RGB at bytes 18, 19, and 20.
    """
    ...
    # *** THIS IS THE FIX ***
    # Inject the RGB color at the correct offsets: 18, 19, 20
    packet_list[18] = r
    packet_list[19] = g
    packet_list[20] = b
    ...
    try:
        ...
        while True:
            try:
                ...
                # Create the full 3-packet sequence with the correct color location.
